...
public class CrimeCameraFragment extends Fragment {
    ...
    public static final String EXTRA_PHOTO_FILENAME = "com.example.administrator.photo_filename";
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(TAG, "Error to closing file " + filename, e);
                    success = false;
                }
            }
            if (success) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTakePicture = (Button) v.findViewById(R.id.crime_camera_takePictureButton);
